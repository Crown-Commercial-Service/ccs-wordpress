...
class SupplierRepository extends AbstractRepository
{
    ...
    public function findLotSuppliers($lotIds, $paginate = false, $limit = 20, $page = 0) {
        ...
        $sql = 'SELECT DISTINCT s.id, s.salesforce_id, s.name, ls.trading_name, s.phone_number, s.street, s.city, s.postcode, s.website, s.country, ls.contact_email FROM `ccs_suppliers` s
